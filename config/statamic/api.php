...
return [
    ...
    */
    ...
    'resources' => [
        'collections' => [
            'pages' => [
                'allowed_filters' => ['slug', "order", "site"],
            ],
            'products' => [
                'allowed_filters' => ['title', 'slug', "site", 'product_categories'],
            ],
            'careers' => [
                'allowed_filters' => ['title', 'slug', "site", 'career_categories', 'career_location', 'career_department'],
            ],
        ],
        'navs' => false,
        'taxonomies' => [
            'product_categories' => [
                'allowed_filters' => ["locale", "site"],
            ],
            'career_categories' => [
                'allowed_filters' => ["locale", "site"],
            ],
